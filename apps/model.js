...
export const TYOV = {
  ...
  "10a":
    "The stars pinwheel above you in the night. The seasons are a blur. You are as an automaton, unconscious of the passage of decades. A century passes. Strikeout a Memory. Strikeout all mortal Characters.",
  "10b":
  ...
  "12c":
    "A mortal protege outstrips you. They are smarter, crueler, and more capable than you can ever be. They lock you in a dungeon\u2014for what purpose do they use you? Create a wicked mortal Character.",
  "13a":
    "Generations of the same family serve you. This line starts from any living mortal Character, or from the descendants of a dead mortal Character. What bizarre rituals do they tie to their servitude? Lose a Resource and create a Servitor of the Lineage Resource.",
  "13b":
  ...
  "21c":
    "Decades pass. The child has died of old age. You stand at their grave. What more could you have done to make their life better? How did you betray them? Strikeout that Character with great ceremony.",
  "22a":
  ...
  "31a":
    "You fall into a deep slumber for a hundred years. Strikeout any mortal Characters.",
  "31b":
  ...
  "33c":
    "A massive shift of power happens in the mortal realm. Governments fall, wars are waged, and a new order is created. Who benefits? Check a Skill. Commit atrocious deeds to gain a Resource related to controlling innocent people. Take the Skill Join the Winning Side or instead check two Skills.",
  "34a":
  ...
  "36b":
    "Punish someone because of this false Memory. You kill or maim a Character. Check a Skill. Take the Skill I Know What's Real.",
  "36c":
  ...
  "39a":
    "Age has damaged your Diary. Strikeout three nouns from the Memories in your Diary, starting from the oldest entry. If you have no Diary, do this to the first three nouns in a Memory of middling age.",
  "39b":
  ...
  "39c":
    "Find a character record from an earlier playthrough of this game. Swap a Memory for one from that character sheet.",
  "40a":
  ...
  "48a":
    "You awaken covered in dust. Generations have passed. Your sleeping place has been sealed off. How do you escape? Lose a Resource. Strikeout all mortal Characters.",
  "48b":
  ...
  "61b":
    "You frequently confuse living mortals with a dead Character. Take the Mark I See [dead Character][a][b] Everywhere.",
  "61c":
